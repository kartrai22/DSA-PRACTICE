...
The JVM (Java Virtual Machine) interprets bytecode and uses **JIT (Just-In-Time)** compilation to optimize hot paths at runtime.`
      },
      {
...
\`\`\``
      },
      {
        ...
        content: `## Virtual Threads (Project Loom)
